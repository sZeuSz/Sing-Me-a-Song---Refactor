...
import { RecommendationPromise, RecommendationWithScore } from "../protocols/recommendation";

export async function create({ name, youtubeLink, initialScore } : RecommendationWithScore) {
...
export async function findById(id: number): Promise<RecommendationPromise> {
